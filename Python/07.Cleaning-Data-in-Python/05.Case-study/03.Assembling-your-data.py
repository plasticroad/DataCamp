...
contain the Gapminder life expectancy data for, respectively, the 19th century, 
...
INSTRUCTIONS
100 XP
Use pd.concat() to concatenate g1800s, g1900s, and g2000s into one DataFrame 
called gapminder. Make sure you pass DataFrames to pd.concat() in the form of a 
list.
