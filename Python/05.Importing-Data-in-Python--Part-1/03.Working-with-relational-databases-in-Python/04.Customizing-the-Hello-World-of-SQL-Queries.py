...
Congratulations on executing your first SQL query! Now you're going to figure out 
...
Apply the method fetchmany() to rs in order to retrieve 3 of the records. Store 
them in the DataFrame df.
