...
Employee table and orders them in increasing order by the column BirthDatAssign 
the result to rs.
In a call to pd.DataFrame(), apply the method fetchall() to rs in order to fetch 
