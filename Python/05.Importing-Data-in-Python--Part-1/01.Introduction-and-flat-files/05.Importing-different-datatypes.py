...
would throw you a ValueError and tell you that it could not convert string 
to float. There are two ways to deal with this: firstly, you can set the data 
...
tab-delimited, the datatype is float, and you want to skip the first row.
