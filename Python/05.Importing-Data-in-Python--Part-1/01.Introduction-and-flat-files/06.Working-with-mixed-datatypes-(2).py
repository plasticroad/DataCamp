...
There is also another function np.recfromcsv() that behaves similarly to 
np.genfromtxt(), except that its default dtype is None. In this exercise, 
...
Run the remaining code to print the first three entries of the resulting 
array d.
'''
