...
As a data scientist, you'll often be dealing with a lot of data, and it will make 
sense to group some of this data.
...
script on the right can already give you an idea.
