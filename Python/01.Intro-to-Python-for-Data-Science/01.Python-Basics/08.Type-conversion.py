...
to summarize the results in a string. Assuming the floats savings and result are 
defined, you can try something like this:
...
Fix the code on the right such that the printout runs without errors; use the 
