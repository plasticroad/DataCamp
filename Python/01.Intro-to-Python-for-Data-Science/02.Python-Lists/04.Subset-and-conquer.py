...
definition is already in the script. Can you add the correct code to do some Python 
subsetting?

INSTRUCTIONS
100 XP
Print out the second element from the areas list, so 11.25.
Subset and print out the last element of areas, being 9.50. Using a negative index 
makes sense here!
